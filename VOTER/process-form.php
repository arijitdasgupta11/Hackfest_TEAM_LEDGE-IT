...
<body style="text-align:center;">
	...
	<button style="background-color:light-grey; padding:10px 20px; border-radius:6px;">
		...
		href="http://localhost/Final%20Voting/DAPP/VOTER/voterportal.php">Go Back
	</a>
	</button>
<?php
$adhar = $_POST["an"];
...
$sql1 = "SELECT * FROM adhaar where adhaarno='$adhar' and votern='$von' and adhaar.Name='$n' and Age>17";
